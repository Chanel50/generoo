  ...
  <form onSubmit={handleSearch}>
    <div className="flex justify-center srh">
      ...
      <div className="relative w-full">
        ...
        <button
          type="submit"
          className=" p-2.5 text-sm font-medium h-full text-white bg-amber-400 rounded-r-lg border border-amber-400 hover:bg-amber-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
